...
I now host a web version of this tool. You can specify a tournament ID and a school name and it will return your summary (it may ask for a little bit of time to generate it first). Send me a message at redbeardben@gmail.com if you want the website URL.
...
COMING SOON! The refactor changed things up quite a bit!
