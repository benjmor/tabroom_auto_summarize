...
I now host a web version of this tool at [tabroomsummary.com](https://tabroomsummary.com). You can specify a tournament ID and a school name and it will return your summary (it may ask for a little bit of time to generate it first).
