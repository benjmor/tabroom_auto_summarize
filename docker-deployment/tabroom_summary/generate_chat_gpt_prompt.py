...
def generate_chat_gpt_prompt(
    ...
    """
    Generates a text prompt to send to ChatGPT, telling it what to create. Does not contain the results, but does contain a data header.
...
Write a 3 paragraph summary for the {school_name} speech and debate team social media feed. Use as many student names of {school_name} students as reasonable. Write concisely and professionally. Keep the tone factual and concise. Include individuals' rankings, wins, and placement out of the total number of entries.
    """
    ]
